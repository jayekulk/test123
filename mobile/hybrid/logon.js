sap.hybrid.kapsel = {
		...
		sap.Logon.init(
			function(context) {
				...
				if (context) {
					...
					console.log("doLogonInit() return null");
				}
			},
			function(errObj) {
				console.log("doLogonInit() Error");
	...
	doLogonUnlock: function() {
		...
		sap.Logon.unlock(
			...
			function(errObj) {
				console.log("doLogonUnlock() Error");
				console.log(JSON.stringify(errObj));
			});
	},
	...
	doLogonShowRegistrationData: function() {
		...
		sap.Logon.showRegistrationData(
			...
			function(errObj) {
				console.log("doLogonShowRegistrationData() Error");
				console.log(JSON.stringify(errObj));
			});
	},
	...
	doLogonChangePassword: function() {
		...
		sap.Logon.changePassword(
			...
			function(errObj) {
				console.log("doLogonChangePassword() Error");
				console.log(JSON.stringify(errObj));
			});
	},
	...
	doLogonManagePasscode: function() {
		...
		sap.Logon.managePasscode(
			...
			function(errObj) {
				console.log("doLogonManagePasscode() Error");
				console.log(JSON.stringify(errObj));
			});
	},
	...
	doLogonSetDataVaultValue: function(theKey, theValue) {
		...
		if (theKey !== "" && theValue !== "") {
			...
			sap.Logon.set(
				...
				function(errObj) {
					console.log("doLogonSetDataVaultValue() Error");
					console.log(JSON.stringify(errObj));
				}, theKey, theValue);
		} else {
	...
	doLogonGetDataVaultValue: function(theKey) {
		...
		if (theKey !== "") {
			...
			sap.Logon.get(
				...
				function(errObj) {
					console.log("doLogonGetDataVaultValue() Error");
					console.log(JSON.stringify(errObj));
				}, theKey);
		} else {
			//One of the input values is blank, so we can't continue
